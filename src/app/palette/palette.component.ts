...
export class PaletteComponent implements OnInit {
  ...
  url: string = 'https://pixabay.com/api/?key=11873174-c12f4530bab32261bf10fb3af&per_page=30&orientation=';
  // url_2: string = 'https://pixabay.com/api/?key=11873174-c12f4530bab32261bf10fb3af&page=1&orientation=vertical';
  images: any[] = [];
